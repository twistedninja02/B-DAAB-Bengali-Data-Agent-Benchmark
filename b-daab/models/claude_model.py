...
class ClaudeSQLModel(BaseSQLModel):
    def __init__(self, model_name: str = "claude-3-5-sonnet-20241022", system_instruction: str = None):
    ...
    def generate_sql(self, query: str, schema: str) -> str:
        if not self.api_key:
            print("[Warning] ANTHROPIC_API_KEY not defined. Invoking offline rule generation.")
        ...
        try:
            ...
            raw_sql = message.content[0].text or ""
